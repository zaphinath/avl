...
public class TestDriver {
	...
	System.out.println("Tree Add Test");
  treeAddTest(testSet);
	...
	for (int i = 0; i < randoms.length; i++) {
	    ...
	    System.out.println("comparing set Random contents");
	    compareContents(goodSet, testSet);
	    System.out.println("\t\tPASSED");
	}
    }
    ...
    System.out.println("Integers match " + expected);
    }
	...
	while (iter.hasNext()) {
      ...
      System.out.println("TEST " + item);
		System.out.println(name + " contains " + item.toString());
		System.out.println(superName + "4s doesn't contain " + item.toString());
		failed();
	    }
	}
    }
